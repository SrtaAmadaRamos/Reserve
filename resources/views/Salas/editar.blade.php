            ...
            <form method="post" class="mt-4">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-sm-6">
                        ...
                        <input name="numero" type="number" class="form-control" id="numero" value="{{$sala->numero}}" placeholder="123456789" required>
                    ...
                    <div class="mb-3 col-sm-6">
                        ...
                        <select name="responsavel_id" id="responsavel_id" class="form-select" required>
                            @foreach($responsaveis as $responsvel)
                                <option value="{{$responsvel->id}}" {{$sala->responsavel_id == $responsvel->id ? 'selected' : ''}} >{{$responsvel->nome}}</option>
                            @endforeach
                        </select>
